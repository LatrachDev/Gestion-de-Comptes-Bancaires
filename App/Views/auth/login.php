...
<head>
    ...
    <script src="../../../Public/JavaScript/tailwind.js"></script>
</head>
<body>
    <main class="bg-[url('../../../Public/images/bg2.jpg')] w-full h-screen bg-cover bg-center flex justify-center items-center bg-gray-900/60 backdrop-blur-lg">
